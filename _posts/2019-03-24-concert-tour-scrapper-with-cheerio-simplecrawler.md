...
summary: "Learn how to scrape concert information from the Red Hot Chili Peppers' tour website using Node.js, Cheerio, and Simple Crawler, and transform the data through a series of middleware plugins."
date: 2019-03-24
permalink: /posts/:title/
tags: ["javascript", "cheerio.js", "simple-crawler"]
image: "/images/js.png"
---
...
![Alt text](/images/RHCP-Mindmap.png "RHCP-Mindmap")
...
![Alt text](/images/RHCP-Past-Tour-Pagination.png "RHCP-Past-Tour-Pagination")

Inspecting this element we see this:

![Alt text](/images/RHCP-Past-Tour-Pagination-Inspector.png "RHCP-Past-Tour-Pagination-Inspector")
...
![Alt text](/images/Middleware.png "Middleware")
...
```js showLineNumbers title="src/plugins/GeoJSON.js"
...
Congratulations! You've built a fairly involved crawler and scrapper including a plugin system that feeds into the crawler middleware - both of which you created! Next time, we'll add tests to this crawler to be confident of our code.
